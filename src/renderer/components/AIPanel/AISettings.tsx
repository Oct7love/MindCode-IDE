                      ...
                      style={{
                        ...
                        background:
                          config.provider === key
                            ...
                            : "var(--color-bg-base)",
                        color: config.provider === key ? "#fff" : "inherit",
                        border: "1px solid var(--color-border)",
                        borderRadius: 4,
                        cursor: "pointer",
                        fontSize: 11,
                ...
                >
                  <div>
                    ...
                    <div style={{ fontSize: 11, color: "var(--color-text-muted)", marginTop: 2 }}>
                      自动选择模型：简单任务用 Haiku，复杂任务用主模型
                    </div>
                  </div>
                  <label
                    style={{ position: "relative", display: "inline-block", width: 40, height: 20 }}
                  >
                    <input
                      type="checkbox"
