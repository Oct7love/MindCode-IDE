...
import { getComposer, type ComposerPlan } from "../../core/agent";
...
export const ComposerPanel: React.FC<ComposerPanelProps> = ({ isOpen, onClose, workspacePath }) => {
  ...
  const selectedEdit = useMemo(
    () => plan?.edits.find((e) => e.path === selectedFile),
    [plan, selectedFile],
  );
      ...
      >
        ...
        <div style={{ padding: 16, borderBottom: "1px solid var(--color-border, #333)" }}>
          <textarea
            ...
            placeholder="描述你想要的重构... 例如：将所有 var 改为 const，重命名 getUserData 为 fetchUser"
            style={{
              width: "100%",
              height: 60,
        ...
        {progress && (
          ...
          >
            ...
            >
              ...
              <div
                style={{ flex: 1, height: 4, background: "var(--color-border)", borderRadius: 2 }}
              >
                <div
                  style={{
        ...
        <div style={{ flex: 1, display: "flex", overflow: "hidden" }}>
          {/* File List */}
          <div
            style={{ width: 250, borderRight: "1px solid var(--color-border)", overflow: "auto" }}
          >
            {plan?.edits.map((edit) => (
              <div
                key={edit.path}
                ...
                style={{
                  ...
                  cursor: "pointer",
                  background:
                    selectedFile === edit.path ? "var(--color-bg-hover, #1f1f23)" : "transparent",
