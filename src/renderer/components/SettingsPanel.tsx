...
const SETTINGS: SettingItem[] = [
  ...
  // 外观
  {
    ...
    category: "外观",
    default: "dark",
    options: ["dark", "light", "abyss", "monokai"],
  },
  ...
  },
  {
    ...
    category: "文件",
    default: "utf-8",
    options: ["utf-8", "gbk", "gb2312", "utf-16"],
  },
  // Git
    ...
    >
      ...
      >
        ...
        <div style={{ flex: 1, display: "flex", overflow: "hidden" }}>
          {/* Categories */}
          <div
            style={{ width: 150, borderRight: "1px solid var(--color-border)", overflow: "auto" }}
          >
            <div
              ...
              style={{
                padding: "10px 12px",
                cursor: "pointer",
                background: !activeCategory ? "var(--color-bg-hover)" : "transparent",
                fontSize: 13,
              }}
            >
              全部
            ...
            {categories.map((cat) => (
              <div
                ...
                style={{
                  padding: "10px 12px",
                  cursor: "pointer",
                  background: activeCategory === cat ? "var(--color-bg-hover)" : "transparent",
                  fontSize: 13,
                }}
              >
                {cat}
