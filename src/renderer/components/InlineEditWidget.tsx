...
请直接输出修改后的代码，不需要任何解释或 markdown 格式。只输出纯代码。`;
  ...
  const _displayCode = streamingCode || generatedCode;
      ...
      <div className="inline-edit-container">
        ...
        {showDiff && generatedCode && (
          <div className="inline-edit-actions">
            <button className="inline-edit-btn inline-edit-btn-secondary" onClick={onClose}>
              <kbd>Esc</kbd> 拒绝
            </button>
            <button className="inline-edit-btn inline-edit-btn-primary" onClick={handleApply}>
              <kbd>Tab</kbd> 接受
            </button>
          </div>
        )}
